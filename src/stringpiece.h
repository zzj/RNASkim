...
// We only change the namespace from re2 to rs.
// And we do not own the copyright of this file.
...
extern std::ostream& operator<<(std::ostream& o, const rs::StringPiece& piece);
